...
class BiditemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'iteminfo' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'iteminfo' => 'Lorem ipsum dolor sit amet',
                'finished' => 1,
                'endtime' => '2020-11-04 21:32:27',
                'created' => '2020-11-04 21:32:27',
            ],
        ];
        parent::init();
    }
